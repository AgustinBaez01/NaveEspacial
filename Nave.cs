...
namespace NaveEspacial
{
    internal class Nave
    {
        ...
        //Posición de la nave en la consola.
        ...
        public void Dibujar()
        {
            ...
            // Ubicamos la letra "A" de la nave, la punta de la nave.
            ...
            //Guardamos la posición de cada letra.
            //Fila 1
        ...
        //Borrar los elementos de la consola.
        public void Borrar()
        {
        ...
        public void Teclado(ref Point distancia, int velocidad)
        {
            ...
            //Movimiento de la nave teclas WASD
            ...
            if(tecla.Key == ConsoleKey.L)
            {
                if (!SobreCargaCond)
                {
                    Bala bala = new Bala(new Point(Posicion.X + 6, Posicion.Y + 2), ConsoleColor.Green, TipoBala.Normal);
                    Balas.Add(bala);
            ...
            if (tecla.Key == ConsoleKey.J)
            {
                if (!SobreCargaCond)
                {
                    Bala bala = new Bala(new Point(Posicion.X, Posicion.Y + 2), ConsoleColor.Green, TipoBala.Normal);
                    Balas.Add(bala);
            ...
            if (tecla.Key == ConsoleKey.I)
            {
               if (BalaEspecial >= 100) 
                {
                    Bala bala = new Bala(new Point(Posicion.X + 2, Posicion.Y - 2), ConsoleColor.Green, TipoBala.Especial);
                    Balas.Add(bala);
                    BalaEspecial = 0;
                }
            }
        ...
        {   //Esta propiedad devuelve verdadero si se presiono una tecla y falso si no.
...
//16:36 / 38:11 Disparos de la nave
// PARTE 3
