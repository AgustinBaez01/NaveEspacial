...
namespace NaveEspacial
{
    internal class Ventana
    {
        ...
        private void Init()
        {
            ...
            // Para que no se vea el cursor.
            Console.CursorVisible = false;
            Console.BackgroundColor = Color;
            // Limpiar el buffer de la consola para que se actualice al nuevo color.
            Console.Clear();
            _enemigo1 = new Enemigo(new Point(50, 10), ConsoleColor.Cyan, this, TipoEnemigo.Menu, null);
            _enemigo2 = new Enemigo(new Point(10, 30), ConsoleColor.Red, this, TipoEnemigo.Menu, null);
        ...
        public void CrearBalas()
        {
            ...
            _balas.Add(bala1);
            Bala bala2 = new Bala(new Point(0, 0), ConsoleColor.Green, TipoBala.Menu);
            _balas.Add(bala2);
            Bala bala3 = new Bala(new Point(0, 0), ConsoleColor.Magenta, TipoBala.Menu);
            _balas.Add(bala3);
            Bala bala4 = new Bala(new Point(0, 0), ConsoleColor.Blue, TipoBala.Menu);
            _balas.Add(bala4);
            Bala bala5 = new Bala(new Point(0, 0), ConsoleColor.DarkCyan, TipoBala.Menu);
            _balas.Add(bala5);
            Bala bala6 = new Bala(new Point(0, 0), ConsoleColor.Yellow, TipoBala.Menu);
            _balas.Add(bala6);
            Bala bala7 = new Bala(new Point(0, 0), ConsoleColor.DarkRed, TipoBala.Menu);
            _balas.Add(bala7);
            Bala bala8 = new Bala(new Point(0, 0), ConsoleColor.DarkGray, TipoBala.Menu);
            _balas.Add(bala8);
            Bala bala9 = new Bala(new Point(0, 0), ConsoleColor.DarkYellow, TipoBala.Menu);
            _balas.Add(bala9);
            Bala bala10 = new Bala(new Point(0, 0), ConsoleColor.DarkGreen, TipoBala.Menu);
            _balas.Add(bala10);
            Bala bala11 = new Bala(new Point(0, 0), ConsoleColor.Gray, TipoBala.Menu);
            _balas.Add(bala11);
            Bala bala12 = new Bala(new Point(0, 0), ConsoleColor.White, TipoBala.Menu);
            _balas.Add(bala12);
            Bala bala13 = new Bala(new Point(0, 0), ConsoleColor.White, TipoBala.Menu);
            _balas.Add(bala13);
            Bala bala14 = new Bala(new Point(0, 0), ConsoleColor.Blue, TipoBala.Menu);
            _balas.Add(bala14);
            Bala bala15 = new Bala(new Point(0, 0), ConsoleColor.Red, TipoBala.Menu);
            _balas.Add(bala15);
            Bala bala16 = new Bala(new Point(0, 0), ConsoleColor.Green, TipoBala.Menu);
            _balas.Add(bala16);
            Bala bala17 = new Bala(new Point(0, 0), ConsoleColor.DarkBlue, TipoBala.Menu);
            _balas.Add(bala17);
            Bala bala18 = new Bala(new Point(0, 0), ConsoleColor.Yellow, TipoBala.Menu);
            _balas.Add(bala18);
            Bala bala19 = new Bala(new Point(0, 0), ConsoleColor.DarkCyan, TipoBala.Menu);
            _balas.Add(bala19);
